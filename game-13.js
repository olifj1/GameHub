(() => {
  ...
  const COURSE_DEFS = {
    ...
    medium: {
      ...
      commands: [
        ["L", [2250, 300]],
        ["C", [2550, 300], [2780, 450], [2800, 700]],
        ["C", [2820, 900], [2700, 1040], [2500, 1060]],
        ["L", [2250, 1080]],
        ["C", [2070, 1090], [1970, 1210], [2030, 1350]],
        ["C", [2090, 1480], [2270, 1510], [2370, 1630]],
        ["C", [2490, 1770], [2380, 1910], [2200, 1920]],
        ["L", [1700, 1940]],
        ["C", [1520, 1950], [1430, 2090], [1510, 2220]],
        ["C", [1600, 2370], [1430, 2470], [1240, 2440]],
        ["L", [720, 2360]],
        ["C", [470, 2320], [310, 2160], [340, 1970]],
    ...
    hard: {
      ...
      commands: [
        ...
        ["C", [2460, 820], [2340, 930], [2180, 930]],
        ["C", [2020, 930], [1940, 1030], [2020, 1150]],
        ["C", [2090, 1260], [2030, 1360], [1870, 1390]],
        ["C", [1720, 1420], [1600, 1490], [1480, 1550]],
        ["C", [1320, 1630], [1230, 1740], [1090, 1770]],
        ["C", [920, 1810], [780, 1740], [650, 1810]],
        ["C", [480, 1900], [470, 2100], [620, 2200]],
        ["C", [800, 2320], [1030, 2230], [1210, 2180]],
        ["L", [1580, 2180]],
        ["C", [1770, 2180], [1920, 2110], [1960, 1980]],
        ["C", [2000, 1840], [1910, 1760], [1800, 1780]],
        ["C", [1680, 1800], [1620, 1710], [1690, 1620]],
        ["C", [1780, 1500], [1700, 1410], [1570, 1350]],
        ["L", [1380, 1260]],
  ...
  function bestTimeKey() {
    return `${course?.recordKey || difficulty}:${carType}`;
  }
