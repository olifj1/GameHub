window.APP_CONFIG = {
  ...
  "games": [
    ...
    },
    {
      ...
      "path": "game-08.html?v=1.7.0"
    },
    {
      "id": "game-12",
      "displayName": "Colour Blocks",
      "description": "Reverse rows and columns to rebuild four solid blocks of colour.",
      "icon": "▦",
      "enabled": true,
      "progress": {
        "enabled": true,
