window.APP_CONFIG = {
  ...
  "games": [
    ...
    },
    {
      ...
      "path": "game-10.html?v=1.7.7"
    },
    {
      "id": "game-13",
      "displayName": "Racer",
      "description": "Race compact circuits, chase faster laps and adapt to changing grip.",
      "icon": "\u25b0",
      "enabled": true,
      "progress": {
        "enabled": true,
