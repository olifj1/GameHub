window.APP_CONFIG = {
  ...
  "games": [
    ...
    },
    {
      ...
      "path": "game-08.html?v=1.7.1"
    },
    {
      "id": "game-12",
      "displayName": "Colour Blocks",
      "description": "Shift whole rows and columns to rebuild four solid blocks of colour.",
      "icon": "▦",
      "enabled": true,
      "progress": {
        "enabled": true,
