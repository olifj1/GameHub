...
Unzip `GameHub-v1.0.7.zip`, open the `GameHub-v1.0.7` folder, Select All, and
...
## v1.0.7 Tell the Time refinement
...
- Increased the Tell the Time analogue clock size without making it dominate the page.
- Increased the digital time size slightly for better balance.
- Added a little more separation before the day-cycle and controls panels.
